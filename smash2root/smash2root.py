...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If the file has written permission, it can be abused by adding a new user with root privilege to the file. If it's  ║")
print("\t║no't writable, then it's protected.                                                                                 ║")
...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If any hash is found in the /etc/passwd, the attacker my try to crack it by using any hash cracker software, tool.  ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"[+] Shadow file:",XX)
os.system ('ls -la /etc/shadow --color=always')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If the file has read/write permission, it can abuse by replacing the root HASH with the attacker's HASH or the      ║")
print("\t║attacker my copy the hash & try to crack it.                                                                        ║")
print("\t║",RED,"Exploit:",XX,"                                                                                                        ║")
...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║The file shows a fully detailed about what the current user my run as root. If the running file or the application  ║")
print("\t║has a global vulnerability, the attacker may google it and abuse it for user escalation.                            ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
...
print("\n",BLUE,"[+] Pivoting:",XX)
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Try to scan the host network and see if there is any other host online, use any of:                                 ║")
...
print("\t╔═══════════════════════════════════════════════════════════════════════════════╗")
print("\t║smash2root search has excluded the following directory:-                       ║")
