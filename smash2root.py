...
print("\t║Docker group:                                                                                                       ║")
print("\t║Run:                                                                                                                ║")
print("\t║    A) docker run -v /root:/mnt -it alpine                                                                          ║")
print("\t║    B) docker ps -a                                                                                                 ║")
print("\t║       docker start wizardly_lovelace                                                                               ║")
print("\t║       docker exec -it wizardly_lovelace /bin/sh                                                                    ║")
print("\t║    C) docker run -v /root:/mnt -it 965                                                                             ║")
