...
\t██████████▄▄▄▄▄▄        ▄▄▄▄▄▄██████████  ██████╔╝██║ ╚═╝ ██║██║  ██║██████╔╝██║  ██║     ███████╗     ██║  ██║╚█████╔╝╚█████╔╝   ██║
\t      ▀▀▀██████████████████████▀▀▀        ╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝     ╚══════╝     ╚═╝  ╚═╝ ╚════╝  ╚════╝    ╚═╝
\t                                          ═════════════════════════════════════════════════════════{\033[01;31mPrivilege Escalation Script v3.0\033[0m}
...
echo -e "\n${BLUE}╔═════{User ID & Groups possible escap:${XX}"
    id | grep --color=always -i "docker\|lxd\|sambashare\|lpadmin\|adm\|sudo\|video\|disk\|disk\|shadow\|fail2ban" 2>/dev/null
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t║Docker:                                                                                                             ║"
        echo -e "\t║Run:                                                                                                                ║"
...
echo -e "\n${BLUE}╔═════{Any credentials in apache2.conf file:${XX}"
    cat /etc/apache2/apache2.conf | grep -i "pass\|cred\|hash" --color=always 2>/dev/null
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
...
echo -e "\n${BLUE}╔═════{MySQL Version:${XX}"
    mysql --version 2>/dev/null --color=always
        echo -e "\t╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t║Server version: 5.7.30 MySQL Community Server (GPL)                                                           ║"
...
echo -e "\n${BLUE}╔═════{Is mysql service running as root:${XX}"
    ps -aux | grep mysql 2>/dev/null --color=always
        echo -e "\t╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t║If so, escalate privilege root via user defined database functions (UDFs)                                     ║"
