...
#------------------> Password File Permission:
    ...
    echo -e "\033[1;31;40m [+]------------------------------------------------------- [ Password File Permission ] -------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
    ...
    ls_passwd=`ls -la /etc/passwd 2>/dev/null`
    echo -e "$ls_passwd"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
        ...
        echo -e "\t  ╚══════════════════════════════════════════════════════════════════════════════╝"
    read_passwd=`cat /etc/passwd 2>/dev/null`
    echo -e "\n$read_passwd"

   #------------------> Hash in Password File:
    echo -e "\n\033[1;34;40m[+] Hash in Password file\033[0m"
    hash=`grep -v '^[^:]*:[x]' /etc/passwd 2>/dev/null`
    echo -e "$hash"

    #------------------> Shadow File:
    echo -e "\n\033[1;34;40m[+] Shadow file\033[0m"
    ls_shadow=`ls -la /etc/shadow 2>/dev/null`
    echo -e "$ls_shadow"
        echo -e "\t  ╔═══════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t  ║If the file has read/write permission, it can abused by replacing the root HASH║"
        echo -e "\t  ║with the attacker's HASH. It can be protected by limitting the access to it &  ║"
        echo -e "\t  ║make sure it can be read or written only by root. Do: chmod 600 /etc/shadow    ║"
        echo -e "\t  ║\033[1;31;40mPOC:\033[0m                                                                           ║"
        ...
        echo -e "\t  ╚═══════════════════════════════════════════════════════════════════════════════╝"
    read_shadow=`cat /etc/shadow 2>/dev/null`
    echo -e "\n$read_shadow"

    #------------------> User Group Lists:
    echo -e "\n\033[1;34;40m[+] User Group list\033[0m"
    ls_group=`ls -la /etc/group 2>/dev/null`
    echo -e "$ls_group"
    read_group=`cat /etc/group 2>/dev/null`
    echo -e "$read_group"
    ...
    superusers=`awk -F: '($3 == '0') {print}' /etc/passwd 2>/dev/null`
    echo -e "$superusers"

    #------------------> List users with console:
    echo -e "\n\033[1;34;40m[+] List users with console:\033[0m"
    console=`cat /etc/passwd | grep "sh" 2>/dev/null`
    echo -e "$console"

    #------------------> Root Accounts:
    echo -e "\n\033[1;34;40m[+] Root Accounts:\033[0m"
    root_acc=`grep -v -E "^#" /etc/passwd 2>/dev/null| awk -F: '$3 == 0 { print $1}' 2>/dev/null`
    echo -e "$root_acc"
    ...
    root_history=`ls -la /root/.*_history 2>/dev/null`
    echo -e "$root_history"

#------------------> System Information:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]---------------------------------------------------------- [ System Information ] ----------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
    ...
    echo -e "\n\033[0;37;41mEsc Doker\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t  ║A good example of escaping docker is a machine on HackTheBox named READY:     ║"
        echo -e "\t  ║https://www.secjuice.com/htb-ready-walkthrough/                               ║"
        echo -e "\t  ║Read More:-                                                                   ║"
    ...
    echo -e "$sys_ver"
    echo -e "\033[0;37;41mNote\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
    ...
    wws=`find /home -name .sudo_as_admin_successful 2>/dev/null`
    echo -e "$wws"
    ...
    echo -e "\n\033[0;37;41mNote\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
        echo -e "\t  ║If you have write permissions on any folder inside the PATH variable you may  ║"
        echo -e "\t  ║be able to hijack some libraries or binaries. Read more:                      ║"
        echo -e "\t  ║https://github.com/SecWiki/linux-kernel-exploits                              ║"
        echo -e "\t  ╚══════════════════════════════════════════════════════════════════════════════╝"
...
#------------------> System Date/Time:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]----------------------------------------------------------- [ System Date/Time ] -----------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
...
#------------------> System SUID:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]------------------------------------------------------------- [ System SUID ] --------------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
    ...
    wr_conf=`find /etc/ -writable -type f 2>/dev/null | xargs ls -l`
    echo -e "$wr_conf"
    ...
    #------------------> Writeable config files:
    echo -e "\n"
    echo -e "\033[1;34;40mUnexpected commands allows you to read and/or write files or even execute command\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
    ...
    #------------------> Profiles files:
    echo -e "\n"
    echo -e "\033[1;34;40m[+] Profiles files\033[0m"
    ...
    echo -e "\n"
    echo -e "\033[1;34;40m[+] Is the .bashrc file writeable?\033[0m"
...
#------------------> System Process:
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]------------------------------------------------------------ [ System Process ] ------------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
    ...
    echo -e "\n\033[0;37;41mNote\033[0m"
        ...
        echo -e "\t  ║more privileges that it should. You can also use a tool called psyp.          ║"
...
#------------------> System Path Scheduled Tasks:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]------------------------------------------------------ [ System Path Scheduled Tasks ] -----------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1

    #------------------> Current User Crontab:
    echo -e "\n"
    echo -e "\033[1;34;40m[+] Current User Crontab\033[0m"
    usr_cron=`crontab -l 2>/dev/null`
    echo -e "$usr_cron"

    #------------------> Other User Crontab:
    echo -e "\n"
    echo -e "\033[1;34;40m[+] Other User Crontab\033[0m"
    other_usr_cron=`cut -d ":" -f 1 /etc/passwd | xargs -n1 crontab -l -u 2>/dev/null`
    echo -e "$other_usr_cron"

    #------------------> Scheduled Jobs:
    echo -e "\n"
    echo -e "\033[1;34;40m[+] Scheduled Jobs\033[0m"
    sch_job=`cat /etc/crontab 2>/dev/null`
    echo -e "$sch_job"
    echo -e "\n"
    echo -e "\033[0;37;41mIf the File is Writable\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════════════════════════════════╗"
...
#------------------> Communications & Networking:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]------------------------------------------------------ [ Communications & Networking ] -----------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1

    #------------------> Network Details:
    echo -e "\n\033[1;34;40m[+] Network Details:\033[0m"
    n_details=`/sbin/ifconfig 2>/dev/null`
    echo -e "$n_details"
    echo -e "\n\033[0;37;41mNote\033[0m"
        echo -e "\t  ╔═══════════════════════════════════════════════════════════════════════════════╗"
    ...
    FW_details=`iptables -nvL 2>/dev/null`
    echo -e "$FW_details"

    #------------------> Open Ports:
    echo -e "\n\033[1;34;40m[+]  Open Ports:\033[0m"
    open_port=`netstat -antp 2>/dev/null`
    echo -e "$openport"
    echo -e "\n\033[0;37;41mNote\033[0m"
        echo -e "\t  ╔══════════════════════════════════════════════════════════════════════════════╗"
    ...
    n_route=`route 2>/dev/null`
    echo -e "$n_route"

    #------------------> Hosts File:
    echo -e "\n\033[1;34;40m[+] Hosts File:\033[0m"
    host_file=`cat /etc/hosts 2>/dev/null`
    echo -e "$host_file"

    #------------------> Name Server:
    echo -e "\n\033[1;34;40m[+] Name Server:\033[0m"
    name_server=`cat /etc/resolv.conf 2>/dev/null`
    echo -e "$name_server"

    #------------------> Neighbours:
    echo -e "\n\033[1;34;40m[+] Neighbours:\033[0m"
    Neighbours=`route | ip n && route 2>/dev/null`
    echo -e "$Neighbours"
...
#------------------> Finding SSH Keys:
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]------------------------------------------------------------ [ Finding SSH Keys ] ----------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1
...
#------------------> Extra Creds:
    echo -e "\n"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    echo -e "\033[1;31;40m [+]-------------------------------------------------------------- [ Extra Creds ] -------------------------------------------------------------[+]\033[0m"
    echo -e "\033[1;31;40m [+]############################################################################################################################################[+]\033[0m"
    sleep 1

    #------------------> Look Manually:
    echo -e "\n\033[1;34;40m[+] Mail File:\033[0m"
    mail_file=`fls -la /var/mail/ 2>/dev/null`
    echo -e "$mail_file"

    echo -e "\n\033[1;34;40m[+] Root Directory:\033[0m"
    root_dir=`ls -la /root/ 2>/dev/null`
    echo -e "$root_dir"

    echo -e "\n\033[1;34;40m[+] Home Directory:\033[0m"
    home_dir=`ls -la /home/ 2>/dev/null`
    echo -e "$home_dir"

    echo -e "\n\033[1;34;40m[+] tmp Directory:\033[0m"
    tmp_dir=`ls -la /tmp 2>/dev/null`
    echo -e "$tmp_dir"

    echo -e "\n\033[1;34;40m[+] Backup Directory:\033[0m"
    backup_dir=`ls -la /var/backups 2>/dev/null`
    echo -e "$backup_dir"
    ...
    apa_conf=`cat /var/apache2/config.inc 2>/dev/null`
    echo -e "$apa_conf"
    ...
    mysql=`ls -la /var/lib/mysql 2>/dev/null`
    echo -e "$mysql"
    ...
    sys_file_no_root=`find /lib/systemd/ \! -uid 0 -type f 2>/dev/null |xargs -r ls -la 2>/dev/null`
