...
if option ==6:
        ...
        IP=input(RED+"[+] Enter IP: "+XX)
        PORT=input(RED+"[+] Enter Port: "+XX)
        DOMAIN=input(RED+"[+] Enter Domain: "+XX)
        SUB=input(RED+"[+] Subdomain Wordlist: "+XX)
        print("\n"+BLUE+"[+] Creating a folder to store all results"+XX)
        ...
        if SCAN=='Y' or SCAN=='y':
            ...
            if TYPE=='medusa' or TYPE=='m':
                ...
                print("\n"+BLUE+"[+] Starting Hydra"+XX)
                os.system("hydra -L {} -P {} {} rdp -t 50 2>/dev/null | tee -a RDP_Enumeration/Hydra.txt".format(USER, PASS, IP))
        else:
            print("Thank You For Using Our Tool")
#----- TFTP Scan:
if option ==7:
...
if option ==18:
        ...
        if SCAN=='Y' or SCAN=='y':
            ...
            if TYPE=='medusa' or TYPE=='m':
                ...
                print("\n"+BLUE+"[+] Starting Hydra"+XX)
                os.system("hydra -L {} -P {} {} telnet -t 50 2>/dev/null | tee -a Telnet_Enumeration/Hydra.txt".format(USER, PASS, IP))
        else:
            print("Thank You For Using Our Tool")
#----- Rlogin Scan:
if option ==19:
        ...
        if SCAN=='Y' or SCAN=='y':
            ...
            if TYPE=='medusa' or TYPE=='m':
                ...
                print("\n"+BLUE+"[+] Starting Hydra"+XX)
                os.system("hydra -L {} -P {} {} rlogin -t 50 2>/dev/null | tee -a Rlogin_Enumeration/Hydra.txt".format(USER, PASS, IP))
        else:
            print("Thank You For Using Our Tool")
#----- Docker Scan:
if option ==20:
...
if option ==27:
        ...
        if SCAN=='Y' or SCAN=='y':
            ...
            if TYPE=='medusa' or TYPE=='m':
                ...
                print("\n"+BLUE+"[+] Starting Hydra"+XX)
                os.system("hydra -L {} -P {} {} redis -t 50 2>/dev/null | tee -a Redis_Enumeration/Hydra.txt".format(USER, PASS, IP))
#----- IPsec/IKE VPN Scan:
if option ==28:
        print("\t"+RED+" \t\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════╗"+XX)
        print("\t"+RED+" \t\t ════════════════════════════════════════[ Enumeration ]═════════════════════════════════════════════════ "+XX)
...
if option ==30:
        ...
        if SCAN=='Y' or SCAN=='y':
            ...
            if TYPE=='Patator' or TYPE=='p' or TYPE=='P':
                ...
                print("\n"+BLUE+"[+] Starting Hydra"+XX)
                os.system("hydra -L {} -P {} {} vnc -t 50 2>/dev/null | tee -a VNC_Enumeration/Hydra.txt".format(USER, PASS, IP))
